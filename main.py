...
imgTest = face_recognition.load_image_file('ImagesBasic/Test.png')
...
cv2.putText(imgTest,f'{results}{round(faceDistance[0]),3}',(50,50),cv2.FONT_HERSHEY_COMPLEX,1,(0,0,255),2)
